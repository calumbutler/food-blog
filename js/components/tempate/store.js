define(['exports', 'components/map/actions', 'js/alt', 'esri/map'], function (exports, _componentsMapActions, _jsAlt, _esriMap) {
	/*eslint-disable */
	'use strict';
	...
	var mapStore = _alt['default'].createStore(MapStore, 'MapStore');
